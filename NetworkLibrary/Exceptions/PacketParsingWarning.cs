...
{
	class PacketParsingWarning : Warning
	{
		public PacketParsingWarning(string message, NetworkPacket packet)
			: this(message, packet, null)
		{
		}

		public PacketParsingWarning(string message, NetworkPacket packet, Exception e)
			: base(message, e)
		{
			_packet = packet;
		}
